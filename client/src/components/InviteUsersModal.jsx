    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 border border-white/20 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 border-b border-white/20 flex items-center justify-between sticky top-0 bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 z-10">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-white/60 text-sm">{session?.title}</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          {success && (
            <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-3 text-green-300 text-sm flex items-center space-x-2">
          ...
          <div>
            ...
            <div className="relative">
              ...
              />
              {isSearching && (
                <Loader className="absolute right-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-white/60 animate-spin" />
              )}
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {selectedUsers.map(user => (
                  <div
                    key={user._id}
                    className="flex items-center space-x-2 bg-purple-600/30 border border-purple-500/50 rounded-full px-3 py-1"
                  >
          ...
          <div className="flex space-x-3 pt-4">
            ...
            <button
              ...
              className="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 disabled:from-gray-600 disabled:to-gray-700 text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
            >
              {isInviting ? (
                <>
